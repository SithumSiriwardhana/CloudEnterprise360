using CloudEnterprise360API.DTOs.Authentication;
...
namespace CloudEnterprise360API.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public AuthenticationController(JWTService jwtService, SignInManager<User> signInManager, UserManager<User> userManager)
        {
